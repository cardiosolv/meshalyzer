...
If one is not specified, all structures belong to the default region.
...
An auxiliary set of points on which to display vector/scalar data is 
...
\item[Temporal syncing] Clicking on the ``sync'' button (beside the animation pause button)
      ...
      model window.
\item[Viewport syncing] Clicking ``Image/Viewport Sync'' or pressing ``v'' in the model window 
