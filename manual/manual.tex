...
\begin{description}
    ...
    \item[--numframe] number of frames to output to PNG images (default=1,-1=all)
...
Choosing the appropriate branch cut range will ignore interpolation within the element,
especially when calculating isolines.
Four common ranges are available.
It is suggested that an appropriate colour scale is used which has the same value at the extremes.
