...
Qd n1 n2 n3 n4 [region [regio_label]]
.
.
.
\end{verbatim}
...
\item[Viewport syncing] Clicking ``Image/Sync/Viewport'' or pressing ``v'' in the model window 
     ...
     relative to this orientation will be applied. The simplest way to apply this is to put the linked meshes 
     to their respective default views, orient one to match the other, and then click ``Image/Sync/Set Reference View''
