...
\usepackage[pdftex]{hyperref}                  % Für Referenzerstellung
\usepackage{xspace}
...
IGB is a format developed at the University of Montreal and used in a visualization
program called flounder.
The 3D nature of the data will be ignored but xdim$\times$ ydim$\times$ zdim
...
are triangle files (see section~\ref{sec:tri}) for
