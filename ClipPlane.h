...
private:
  ...
  inline void cb_1_i(Fl_Round_Button*, void*);
  static void cb_1(Fl_Round_Button*, void*);
  inline void cb_2_i(Fl_Round_Button*, void*);
  static void cb_2(Fl_Round_Button*, void*);
  inline void cb_3_i(Fl_Round_Button*, void*);
  static void cb_3(Fl_Round_Button*, void*);
  inline void cb_4_i(Fl_Round_Button*, void*);
  static void cb_4(Fl_Round_Button*, void*);
  inline void cb_5_i(Fl_Round_Button*, void*);
  static void cb_5(Fl_Round_Button*, void*);
  inline void cb_6_i(Fl_Round_Button*, void*);
  static void cb_6(Fl_Round_Button*, void*);
  GLdouble x[6][4]; 
  bool intercept[6]; 
  float dim; 
  TBmeshWin* tbmw; 
  float ctr_intercept[6]; 
public:
  bool on(int cp);
...
private:
  void calc_intercept( int i );
public:
  void update_dir( double x, double y, double z, int cp);
  void darken_bgs();
  void setView( Quaternion r );
  void select_cp( int cp );
};
#endif
