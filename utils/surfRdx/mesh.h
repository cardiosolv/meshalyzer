...
public:
	...
	Mesh(char* filename, bool carpf=false); // passed name of mesh file
	~Mesh();
    ...
    list<string>& surface_names(){ return _surfnames; }
    vector<triangle>& triangle_list(){ return _plist; }
...
private:
    ...
    void loadTri( int v1, int v2, int v3, int i, int s=0 );
};
