...
public:
	...
	triangle() : 
		...
		_mesh(0), bActive(false), _index(-1),_surface(0) {};
	...
	triangle(const triangle& t) :  
		...
		_index(t._index),_surface(t._surface)
	{
		calcNormal();
	};
	...
	void setIndex(int i, int s=0) {_index = i; _surface=s;}
    int  getSurface() const { return _surface; }
...
protected:
    ...
    int _surface; // index into list of surfaces 
};
