...
void ClipPlane::cb_1_i(Fl_Round_Button*, void*) {
  select_cp(0);
}
void ClipPlane::cb_1(Fl_Round_Button* o, void* v) {
  ((ClipPlane*)(o->parent()->parent()->user_data()))->cb_1_i(o,v);
}

void ClipPlane::cb_2_i(Fl_Round_Button*, void*) {
  select_cp(1);
}
void ClipPlane::cb_2(Fl_Round_Button* o, void* v) {
  ((ClipPlane*)(o->parent()->parent()->user_data()))->cb_2_i(o,v);
}

void ClipPlane::cb_3_i(Fl_Round_Button*, void*) {
  select_cp(2);
}
void ClipPlane::cb_3(Fl_Round_Button* o, void* v) {
  ((ClipPlane*)(o->parent()->parent()->user_data()))->cb_3_i(o,v);
}

void ClipPlane::cb_4_i(Fl_Round_Button*, void*) {
  select_cp(3);
}
void ClipPlane::cb_4(Fl_Round_Button* o, void* v) {
  ((ClipPlane*)(o->parent()->parent()->user_data()))->cb_4_i(o,v);
}

void ClipPlane::cb_5_i(Fl_Round_Button*, void*) {
  select_cp(4);
}
void ClipPlane::cb_5(Fl_Round_Button* o, void* v) {
  ((ClipPlane*)(o->parent()->parent()->user_data()))->cb_5_i(o,v);
}

void ClipPlane::cb_6_i(Fl_Round_Button*, void*) {
  select_cp(5);
}
void ClipPlane::cb_6(Fl_Round_Button* o, void* v) {
  ((ClipPlane*)(o->parent()->parent()->user_data()))->cb_6_i(o,v);
}

ClipPlane::ClipPlane( TBmeshWin *tb ) {
  { window = new Fl_Double_Window(575, 685, "Clipping Plane");
    window->user_data((void*)(this));
    { cporienter = new Orienter(190, 490, 190, 190, "Box");
      cporienter->box(FL_UP_BOX);
      cporienter->color(FL_BACKGROUND_COLOR);
      cporienter->selection_color(FL_BACKGROUND_COLOR);
      cporienter->labeltype(FL_NORMAL_LABEL);
      cporienter->labelfont(0);
      cporienter->labelsize(14);
      cporienter->labelcolor(FL_FOREGROUND_COLOR);
      cporienter->align(Fl_Align(FL_ALIGN_CENTER));
      cporienter->when(FL_WHEN_RELEASE);
    } // Orienter* cporienter
    ...
    { Fl_Group* o = new Fl_Group(105, 520, 70, 160, "Clipping plane");
      o->box(FL_SHADOW_BOX);
      { Fl_Round_Button* o = new Fl_Round_Button(115, 530, 45, 15, "1");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
        o->labelsize(18);
        o->callback((Fl_Callback*)cb_1);
      } // Fl_Round_Button* o
      { Fl_Round_Button* o = new Fl_Round_Button(115, 555, 45, 15, "2");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
        o->labelsize(18);
        o->callback((Fl_Callback*)cb_2);
      } // Fl_Round_Button* o
      { Fl_Round_Button* o = new Fl_Round_Button(115, 580, 45, 15, "3");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
        o->value(1);
        o->labelsize(18);
      ...
      { Fl_Round_Button* o = new Fl_Round_Button(115, 605, 45, 15, "4");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
        o->labelsize(18);
        o->callback((Fl_Callback*)cb_4);
      } // Fl_Round_Button* o
      { Fl_Round_Button* o = new Fl_Round_Button(115, 630, 45, 15, "5");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
        o->labelsize(18);
        o->callback((Fl_Callback*)cb_5);
      } // Fl_Round_Button* o
      { Fl_Round_Button* o = new Fl_Round_Button(115, 650, 45, 15, "6");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
        o->labelsize(18);
...
void ClipPlane::calc_intercepts() {
  for( int i=0; i<6; i++ ){
    calc_intercept(i);
    normcb(i);
  }
...
void ClipPlane::calc_intercept( int i ) {
  const GLfloat* ctr = tbmw->model->pt_offset();
  ctr_intercept[i] = -(ctr[0]*x[i][0]+ctr[1]*x[i][1]+ctr[2]*x[i][2]);
}

void ClipPlane::update_dir( double x, double y, double z, int cp) {
  if( cp==0 ) {
    xdir0->value(x);
    ydir0->value(y);
    zdir0->value(z);
...
void ClipPlane::setView( Quaternion r ) {
  if( cporienter->setView( r ) )
    cporienter->redraw();
}

void ClipPlane::select_cp( int cp ) {
  darken_bgs();
  cporienter->cp(cp);
  if( cp==0 ) {
